  ...
  <h5>TOPへ戻る</h5></a></div>
    ...
    <table>
      <div class="sample_iblock">
          <ul>
                <li><a href="saisyu_1.php">フラワーギフト</a></li>
                <li><a href="saisyu_2.php">キッチン用品</a></li>
                <li><a href="saisyu_3.php">ファッション・美容</a></li>
                <li><a href="saisyu_4.php">お菓子ギフト</a></li>
                <li><a href="saisyu_5.php">旅行</a></li>
                <li><a href="saisyu_6.php">暮らしに役立つ</a></li>
                <li><a href="saisyu_7.php">手作りレシピ</a></li>
                <li><a href="saisyu_8.php">パーティグッズ</a></li>
                <li><a href="saisyu_9.php">おすすめ</a></li>
          </ul>
      </div>
    ...
    <span><button type="submit" name="change"><img src= 'kago.jpg' alt="button"></button></span>
  </form>
  </div>
